...
These groups mirror the current web preview and hardware color logic. Color names set the base RGB color; animation patterns only scale brightness.
...
## Preview And Hardware Color Palette

| Color group | Hex | RGB |
|---|---|---|
| Yellow | `#F1E88E` | 241, 232, 142 |
| Purple | `#A25DDB` | 162, 93, 219 |
| Blue | `#4696D8` | 70, 150, 216 |
